...
import { ThemeProvider, Button, Input, Tag } from '@sxo/react';
        ...
        <div className="max-w-md mx-auto">
          <header className="mb-12 flex items-center justify-between">
            <h1 className="text-4xl font-bold italic tracking-tighter">
              ...
              <span className="ml-2 text-2xl not-italic font-normal text-neutral-400">TODOS</span>
            </h1>
                ...
                todos.map((todo) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      {todo.completed && (
                        <Tag variant="solid" color="secondary" className="scale-75">
                          Done
                        </Tag>
                      )}
                      <button
