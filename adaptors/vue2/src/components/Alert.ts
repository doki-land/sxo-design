import { getAlertClasses } from '@sxo/ui';
...
export const Alert = defineComponent({
    ...
    setup(props, { emit, slots, attrs }) {
        ...
        const renderIcon = () => {
            ...
            return h('div', { class: styles.value.icon }, [
                icons[(props.type as keyof typeof icons) || 'info'],
            ]);
        };
        ...
        return () =>
            h('div', { class: [styles.value.container, attrs.class] }, [
                ...
                props.closable &&
                    h('div', { class: styles.value.closeButton, on: { click: handleClose } }, [
                        h(
                            'svg',
                            {
                                attrs: {
