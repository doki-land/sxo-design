...
- **局限性**：由于其过于追求设计的纯粹性，色彩饱和度低，在复杂的 **C 端（面向最终用户）** 或 **B 端（后台管理系统）** 应用中，可能无法提供足够的视觉引导和层次感。
...
4. **Fate/Intertwined Fate (`@sxo/theme-fate`)**
   - **特点**：二次元、游戏化视觉风格。
...
- **Pornhub (`@sxo/theme-pornhub`)**：极高对比度的黑黄配色，适用于极具辨识度的娱乐类或创意类产品。
